  ...
  return (
    <section className='w-full h-[100vh] mt-[100px] relative'>
      <div className='w-full h-full z-2 absolute top-0 bottom-0 left-0 right-0 flex flex-col items-center text-center justify-center'>
        <div className="w-full h-full items-center flex flex-col gap-3 justify-center mb-50">
      ...
      <div className="w-[500px] h-[500px] absolute left-0 bottom-0 left-hero-gradient rounded-full opacity-[0.3]"></div>
    </section>
  )
}