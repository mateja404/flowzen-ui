      ...
      <div className='w-full h-full z-2 absolute top-0 bottom-0 left-0 right-0 flex flex-col items-center text-center justify-center'>
        <div className="w-full h-full items-center flex flex-col gap-3 justify-center mb-80">
            <div className="flex flex-col items-center justify-center">
              ...
              <motion.h1 initial={{ opacity: 0, y: 50, scale: 0.9, filter: 'blur(20px)' }} animate={{ opacity: 1, y: 0, scale: 1, filter: 'blur(0px)' }} transition={{ duration: 1.3 }} className="text-transparent leading-15 md:leading-normal inline-block bg-clip-text bg-gradient-to-r from-green-300 via-green-50 to-green-300 font-bold text-4xl max-sm:text-5xl md:text-7xl lg:text-[125px]">Built for new generations</motion.h1>
              <motion.p initial={{ opacity: 0, y: 50, filter: 'blur(15px)' }} animate={{ opacity: 1, y: 0, filter: 'blur(0px)' }} transition={{ duration: 1.3 }} className="text-white/70 font-[500] text-center max-w-[550px] text-lg">Flowzen is a modern banking app designed for Gen Z. It combines smart cash flow tracking with a calm, intuitive experience - because money should flow, and you should stay Zen.</motion.p>
            </div>
